...
const cn = {
  ...
  Settings: {
    ...
    Access: {
      ...
      CustomModel: {
        Title: "模型列表（名称、别名）",
        SubTitle: "为当前服务商手动添加模型，或从上游 /models 接口获取",
        Name: "模型名称",
        Alias: "模型别名",
        NamePlaceholder: "模型名称，例如 claude-3-5-sonnet-20241022",
        AliasPlaceholder: "模型别名（可选）",
        AliasOptional: "别名（可选）",
        NameHelp: "填写请求上游接口时使用的模型 ID",
        AliasHelp: "仅用于界面显示，留空则显示模型名称",
        Edit: "编辑模型",
        Save: "保存修改",
        Cancel: "取消编辑",
        Add: "添加模型",
        ...
        Fetch: "从 /models 获取",
        Fetching: "正在获取",
        Empty: "当前服务商还没有手动添加的模型",
        EmptyResponse: "上游没有返回任何模型",
        Invalid: "请输入有效的模型名称，且不要包含英文逗号或等号",
  ...
  Mask: {
    ...
    Page: {
      Title: "助理中心",
      SubTitle: (count: number) => `${count} 个助理`,
      Search: "搜索助理",
      Create: "新建",
    },
    Item: {
    ...
    EditModal: {
      Title: (readonly: boolean) => `编辑助理 ${readonly ? "（只读）" : ""}`,
      Download: "下载助理配置",
      Clone: "复制助理",
    },
    Config: {
