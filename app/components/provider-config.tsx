...
import { Input, ListItem, PasswordInput, Select } from "./ui-lib";

/**
 * Renders the provider-specific credential fields without changing the
 * underlying access store contract. Kept separate from the settings shell so
 * provider quirks remain isolated while the page information architecture can
